...
class LegacyFramebufferSurface : public ConsumerBase, public compositionengine::DisplaySurface {
public:
...
private:
    ...
    LegacyFramebufferSurface(HWComposer& hwc, PhysicalDisplayId displayId, const ui::Size& size,
