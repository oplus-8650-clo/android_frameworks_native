...
struct DisplayModeRequest {
    ...
    // Whether to emit DisplayEventReceiver::DISPLAY_EVENT_MODE_AND_FRAME_RATE_CHANGE for a change
    // in refresh rate or render rate. Ignored for resolution changes, which always emit the event.
