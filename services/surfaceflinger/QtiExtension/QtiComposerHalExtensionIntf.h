...
public:
    ...
    virtual Error qtiSetCornerRadius(Display display, V2_1_Layer layer, float x, float y) = 0;
    virtual Error qtiSetPrivacyRegions(Display display, V2_1_Layer layer,
