...
public:
     ...
     * rendering.
     */
    virtual status_t registerGraphicBuffers(const gui::GraphicBuffersRegisterInfo& info) = 0;
     ...
     */
    virtual status_t unregisterGraphicBuffers(const gui::GraphicBuffersUnregisterInfo& info) = 0;
};
...
public:
    enum ISurfaceComposerTag {
        ...
        REGISTER_GRAPHIC_BUFFERS,
        UNREGISTER_GRAPHIC_BUFFERS,
